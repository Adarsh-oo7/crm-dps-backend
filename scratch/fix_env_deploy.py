...
try:
    ...
    print("Writing production .env file to VPS...")
    sftp = ssh.open_sftp()
    ...
    commands = [
        ...
        "export DJANGO_SETTINGS_MODULE=config.settings.production && /var/www/dps-os/venv/bin/python /var/www/dps-os/backend/manage.py collectstatic --noinput",
    ...
    ssh.close()
    print("\nDEPLOYMENT AND ENVIRONMENT FIX COMPLETED SUCCESSFULLY!")
